...
treble_notes = ['G3', 'A3', 'B3'] + [f'{ch}4' for ch in list('CDEFGAB')] + [f'{ch}5' for ch in list('CDEFGAB')] + ['C6', 'D6']
bass_notes = [f'{ch}2' for ch in list('CDEFGAB')] + [f'{ch}3' for ch in list('CDEFGAB')] + [f'{ch}4' for ch in list('CDEF')]
...
def generate_simple_chords(num_chords, clef, chord_probs):
